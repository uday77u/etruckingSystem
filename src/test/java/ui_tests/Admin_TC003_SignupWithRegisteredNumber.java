...
public class Admin_TC003_SignupWithRegisteredNumber extends BaseUITest {
	...
	public void verifySignupRegistration() throws Exception{
	    ...
	    logger.info("*** Starting Admin_TC003_SignupWithRegisteredNumber ***");
	    ...
	    logger.info("STEP 8: Enter phone");
	    ...
	    assertTrue(isCurrentUrlWithSegment("/register"),"Unable to navigate 'register' page,current page url: "+driver.getCurrentUrl());
	        ...
	        logger.error("❌ Assertion failed in Admin_TC003_SignupWithRegisteredNumber: " + ae.getMessage(), ae);
	        throw ae; // rethrow so TestNG marks test as failed
	    } catch (Exception e) {
	        logger.error("❌ Unexpected exception in Admin_TC003_SignupWithRegisteredNumber: " + e.getMessage(), e);
	        throw e; // rethrow so TestNG marks test as failed
	    }
	    logger.debug("application logs end.......");
		logger.info("**** finished Admin_TC003_SignupWithRegisteredNumber  *****"); 
}
