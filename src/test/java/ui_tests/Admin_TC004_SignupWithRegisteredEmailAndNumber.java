...
public class Admin_TC004_SignupWithRegisteredEmailAndNumber extends BaseUITest {
	...
	public void verifySignupRegistration() throws Exception{
		...
		String phone="8867392044";//"9012345678";
	    ...
	    logger.info("*** Starting Admin_TC004_SignupWithRegisteredEmailAndNumber ***");
	    ...
	    assertTrue(isCurrentUrlWithSegment("/register"),"Unable to navigate 'register' page,current page url: "+driver.getCurrentUrl());
	        ...
	        logger.error("❌ Assertion failed in Admin_TC004_SignupWithRegisteredEmailAndNumber: " + ae.getMessage(), ae);
	        throw ae; // rethrow so TestNG marks test as failed
	    } catch (Exception e) {
	        logger.error("❌ Unexpected exception in Admin_TC004_SignupWithRegisteredEmailAndNumber: " + e.getMessage(), e);
	        throw e; // rethrow so TestNG marks test as failed
	    }
	    logger.debug("application logs end.......");
		logger.info("**** finished Admin_TC004_SignupWithRegisteredEmailAndNumber  *****"); 
}
