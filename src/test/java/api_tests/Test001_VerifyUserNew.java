...
public class Test001_VerifyUserNew extends BaseAPITest {
    ...
    public void verifyUser_shouldReturn200_whenRequestIsValid() {
    ...
    public void verifyUser_shouldReturn400_whenEmailIsMissing() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn400_whenPhoneIsMissing() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn400_whenPhoneFormatIsInvalid() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn400_whenPhoneIsTooShort() {
        VerifyUserRequestData request = validUser();
        request.setPhone("98");
    ...
    public void verifyUser_shouldReturn400_whenPhoneIsTooLong() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn400_whenCountryCodeIsMissing() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn400_whenRequestBodyIsEmpty() {
    ...
    public void verifyUser_shouldReturn400_whenFirstNameHasInvalidChars() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn409_whenEmailAlreadyExists() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn409_whenPhoneAlreadyExists() {
        VerifyUserRequestData request = validUser();
    ...
    public void verifyUser_shouldReturn200_withMinimumRequiredFields() {
