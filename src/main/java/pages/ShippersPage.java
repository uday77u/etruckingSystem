...
public class ShippersPage extends BasePage{
	...
	public ShippersPage(WebDriver driver) {
		super(driver);
	...
	//------------------buttons--------------------------------
	By AddShipperButtonBy=By.xpath("//button[text()='Add Shipper']");
	...
	By AddShipperFormBy=By.xpath("//div[contains(@class,'paperAnchorRight')]");
	//displayed web elements
	@FindBy(xpath = "//div[contains(@class,'paperAnchorRight')]") private WebElement AddShipperForm;
	...
	//=======================button actions============================
	public void clickAddshipperButton() {
		muiAct.muiClick(AddShipperButtonBy);
	}
	...
	public Boolean isAddShipperFormisDisplayed() {
		try {
			wbdAct.waitForVisible(AddShipperForm);
			return true;
		} catch (Exception e) {
			return false;
		}
