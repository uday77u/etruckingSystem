...
public class ExternalCarriersPage extends BasePage{
	...
	public ExternalCarriersPage(WebDriver driver) {
		super(driver);
	...
	//------------------buttons--------------------------------
	By AddCarrierButtonBy=By.xpath("//button[text()='Add Carrier']");
	...
	By DOTNumberInputBy=By.xpath("//input[@placeholder='DOT Number']");
	By MCNumberInputBy=By.xpath("//input[@placeholder='MC Number']");
	...
	By AddCarrierFormBy=By.xpath("//div[contains(@class,'paperAnchorRight')]");
	//displayed web elements
	@FindBy(xpath = "//div[contains(@class,'paperAnchorRight')]") private WebElement AddCarrierForm;
	...
	public void clickAddCarrierButton() {
		muiAct.muiClick(AddCarrierButtonBy);
	}
	...
	public void enterDOTNumber(String value) {
		muiAct.muiType(DOTNumberInputBy, value);
	}
	public void enterMCNumber(String value) {
		muiAct.muiType(MCNumberInputBy, value);
	}
	...
	public Boolean isAddCarrierFormisDisplayed() {
		try {
			wbdAct.waitForVisible(AddCarrierForm);
			return true;
		} catch (Exception e) {
			return false;
		}
