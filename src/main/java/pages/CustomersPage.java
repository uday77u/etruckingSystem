...
public class CustomersPage extends BasePage{
	...
	//------------------buttons--------------------------------
	By AddCustomerButtonBy=By.xpath("//button[text()='Add Customer']");
	...
	By AddCustomerFormBy=By.xpath("//div[contains(@class,'paperAnchorRight')]");
	//displayed web elements
	@FindBy(xpath = "//div[contains(@class,'paperAnchorRight')]") private WebElement AddCustomerForm;
	...
	public void clickAddCustomerButton() {
		muiAct.muiClick(AddCustomerButtonBy);
	}
	...
	public Boolean isAddCustomerFormisDisplayed() {
		try {
			wbdAct.waitForVisible(AddCustomerForm);
			return true;
		} catch (Exception e) {
			return false;
		}
