...
public class BrokersPage extends BasePage{
	...
	//------------------buttons--------------------------------
	By AddBrokersButtonBy=By.xpath("//button[text()='Add Broker']");
	...
	//input web elements
	@FindBy(xpath = "//input[@placeholder='MC Number']") private WebElement MCNumberInput;
	...
	//----------------input by locators------------------------
	By MCNumberBy=By.xpath("//input[@placeholder='MC Number']");
	...
	By AddBrokersFormBy=By.xpath("//div[contains(@class,'paperAnchorRight')]");
	//displayed web elements
	@FindBy(xpath = "//div[contains(@class,'paperAnchorRight')]") private WebElement AddBrokersForm;
	...
	//=======================button actions============================
	public void clickAddBrokerButton() {
		muiAct.muiClick(AddBrokersButtonBy);
	}
	...
	public void enterMCNumber(String value) {
		muiAct.muiType(MCNumberBy, value);
	}
	...
	public Boolean isAddBrokersFormisDisplayed() {
		try {
			wbdAct.waitForVisible(AddBrokersForm);
			return true;
		} catch (Exception e) {
			return false;
		}
